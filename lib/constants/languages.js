...
export const LANGUAGES = [
  ...
  { name: 'Northern Ndebele', code: 'nde' },
  ...
  { name: 'Nuosu', code: 'iii' },
  { name: 'Southern Ndebele', code: 'nbl' },
  { name: 'Occitan', code: 'oci' },
  { name: 'Ojibwe', code: 'oji' },
  { name: 'Old Church Slavonic', code: 'chu' },
  { name: 'Oromo', code: 'orm' },
  { name: 'Oriya', code: 'ori' },
  { name: 'Ossetian', code: 'oss' },
  ...
  { name: 'Tibetan Standard', code: 'bod' },
...
export const LANG_LABEL_BY_CODE = LANGUAGES.reduce(
  (map, d) => (
    Object.assign(
      map,
      { [d.code]: <FormattedMessage id={`stripes-acq-components.data.languages.${d.code}`} /> },
    )),
  {},
);

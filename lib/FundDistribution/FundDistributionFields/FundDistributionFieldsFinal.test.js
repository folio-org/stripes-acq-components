...
describe('FundDistributionFieldsFinal', () => {
  ...
  it('should display selected unavailable fund', () => {
    ...
    expect(screen.getAllByText('stripes-acq-components.fundDistribution.unavailableFund')).toBeInTheDocument();
  });
  ...
  it('should display selected inactive fund', () => {
    ...
    expect(screen.getAllByText('TestName (TestCode) - stripes-acq-components.fundDistribution.fundStatus.Inactive')).toBeInTheDocument();
  });
  ...
  it('should call validateRequired for fundId selection', async () => {
    ...
    expect(fundDistributionList).toBeInTheDocument();

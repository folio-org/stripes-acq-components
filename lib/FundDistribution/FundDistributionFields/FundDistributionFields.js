...
const FundDistributionFields = ({
  ...
  const distributionTotal = calculateFundDistributionTotal(fundDistribution, totalAmount, stripes, currency);
  const amounts = fundDistribution.reduce((acc, distr, index) => {
    acc[index] = calculateFundAmount(distr, totalAmount, stripes, currency);

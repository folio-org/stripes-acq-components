...
describe('usePagination', () => {
  ...
  it('should should initialize pagination based on location', () => {
  ...
  it('should should reset offset when search is changed', () => {
  ...
  it('should should call history push when page is changed', () => {
  ...
  it('should should call history push when page is refreshed', () => {

...
describe('useTenantHoldingsAndLocations', () => {
  ...
  it('should fetch holding locations', async () => {
    const { result } = renderHook(() => useTenantHoldingsAndLocations({ instanceId: '1', tenantId: '2' }), { wrapper });
  ...
  it('should fetch holding locations with different tenants', async () => {
    ...
    const { result } = renderHook(() => useTenantHoldingsAndLocations({ instanceId: '1', receivingTenantIds, tenantId: '2' }), { wrapper });

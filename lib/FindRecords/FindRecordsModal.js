...
const DEFAULT_COLUMN_WIDTHS = { isChecked: '34px' };
const DEFAULT_COLUMN_MAPPING = {};
const DEFAULT_RESULTS_FORMATTER = {};
...
export const FindRecordsModal = ({
  ...
  isMultiSelect = false,
  pagination,
  resultsFormatter = DEFAULT_RESULTS_FORMATTER,
  resultsPaneTitle,
  sortableColumns,
  stickyFirstColumn,
  visibleColumns,
...
FindRecordsModal.propTypes = {
  ...
  renderBeforeSearch: PropTypes.func,

...
export class CQLBuilder {
  ...
  greaterThan(field, value) {
    return this._addCondition(field, CQLBuilder.OPERATORS.GREATER_THAN, value);
  }
  ...
  greaterThanEqual(field, value) {
    return this._addCondition(field, CQLBuilder.OPERATORS.GREATER_THAN_EQUAL, value);
  }

  /* Shorthand for greaterThanEqual */
  gte(field, value) {
    return this.greaterThanEqual(field, value);
  }
  ...
  lessThan(field, value) {
    return this._addCondition(field, CQLBuilder.OPERATORS.LESS_THAN, value);
  }
  ...
  lessThanEqual(field, value) {
    return this._addCondition(field, CQLBuilder.OPERATORS.LESS_THAN_EQUAL, value);
  }

  /** Shorthand for lessThanEqual */
  lte(field, value) {
    return this.lessThanEqual(field, value);
  }

import {
  CQL_BUILDER_GROUP_TOKENS,
  CQL_BUILDER_OPERATORS,
  CQL_BUILDER_SORT_ORDERS,
  CQL_BUILDER_SPECIAL_TERMS,
} from './constants';
import {
...
export class CQLBuilder {
  static OPERATORS = CQL_BUILDER_OPERATORS;
  static SORT_ORDERS = CQL_BUILDER_SORT_ORDERS;
  static SPECIAL_TERMS = CQL_BUILDER_SPECIAL_TERMS;
  static GROUP_TOKENS = CQL_BUILDER_GROUP_TOKENS;

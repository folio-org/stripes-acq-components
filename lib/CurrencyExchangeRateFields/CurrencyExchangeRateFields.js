...
const CurrencyExchangeRateFields = ({
  ...
  const visibleFields = useMemo(() => ({
    currencyFieldName: !get(hiddenFields, currencyFieldName, ''),
    currentExchangeRateFiledName: !get(hiddenFields, FILED_NAMES.currentExchangeRate, ''),
    setExchangeRateFiledName: !get(hiddenFields, FILED_NAMES.useSetExchangeRate, ''),
    exchangeRateFieldName: !get(hiddenFields, exchangeRateFieldName, ''),
  ...
  return (
    <Row>
      <IfFieldVisible visible={visibleFields.currencyFieldName} name={currencyFieldName}>
      ...
      <IfFieldVisible visible={visibleFields.currentExchangeRateFiledName} name={FILED_NAMES.currentExchangeRate}>
      ...
      <IfFieldVisible visible={visibleFields.setExchangeRateFiledName} name={FILED_NAMES.useSetExchangeRate}>
      ...
      <IfFieldVisible visible={visibleFields.exchangeRateFieldName} name={exchangeRateFieldName}>

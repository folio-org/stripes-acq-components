...
const CurrencyExchangeRateFields = ({
  ...
  return (
    <Row>
      <IfFieldVisible visible={!get(hiddenFields, currencyFieldName, '')} name={currencyFieldName}>
      ...
      <IfFieldVisible visible={!get(hiddenFields, FILED_NAMES.currentExchangeRate, '')} name={FILED_NAMES.currentExchangeRate}>
      ...
      <IfFieldVisible visible={!get(hiddenFields, FILED_NAMES.useSetExchangeRate, '')} name={FILED_NAMES.useSetExchangeRate}>
      ...
      <IfFieldVisible visible={!get(hiddenFields, exchangeRateFieldName, '')} name={exchangeRateFieldName}>

...
describe('RoutingList', () => {
  ...
  it('should render component', () => {
    ...
    expect(screen.getByText('stripes-acq-components.routing.list.label')).toBeDefined();
  });
  ...
  it('should render routingList data', () => {
    ...
    expect(screen.getByText('stripes-acq-components.routing.list.column.name')).toBeDefined();
  });
});

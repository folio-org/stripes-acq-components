...
export const getRoutingListFormatter = (routingListUrl = DEFAULT_ROUTING_LIST_URL) => ({
  name: record => <TextLink to={`${routingListUrl}/view/${record.id}`}>{record.name}</TextLink>,

...
These components are intended for use by modules and applications that handle Acquisitions (ui-orders, ui-finance, ui-invoice, etc.) duties. Other modules and applications may not find them as useful.
